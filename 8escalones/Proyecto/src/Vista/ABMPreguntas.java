...
public class ABMPreguntas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxTipo
                .setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Multiple choice", "Aproximacion" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ABMPreguntas.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
