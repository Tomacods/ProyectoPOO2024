...
BEGIN
    ...
    IF tematica_id IS NULL THEN
        RAISE EXCEPTION 'No se encontró una temática con el nombre %', tematica_nombre;
    END IF;

    -- Si el tipo de pregunta es "multiple_choise", selecciona de Pregunta_multiple_choise
    ...
    -- Si el tipo de pregunta es "aproximacion", selecciona de Pregunta_aproximacion
    ...
    ELSE
        ...
        RAISE EXCEPTION 'Tipo de pregunta inválido. Debe ser "multiple_choise" o "aproximacion"';
    END IF;
END;
$$ LANGUAGE plpgsql;
 */